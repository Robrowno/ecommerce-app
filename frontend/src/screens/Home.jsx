		...
		<div>
			...
			<div className="p-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
					{laptops.map((laptop) => (
						<div key={laptop._id} className="border rounded-lg p-4 shadow-md">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
					{phones.map((phone) => (
						<div key={phone._id} className="border rounded-lg p-4 shadow-md">
